...
{
    public sealed class RegenerateTwoFactorRecoveryCodesCommandValidator : AbstractValidator<RegenerateTwoFactorRecoveryCodesCommand>
    {
        private readonly IStringLocalizer<SharedResources> _localizer;


        public RegenerateTwoFactorRecoveryCodesCommandValidator(IStringLocalizer<SharedResources> localizer)
        {
